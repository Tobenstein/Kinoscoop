...
export function About() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "I keep this platform independent and watch movies through regular channels (theaters, streaming services, physical media). This ensures my reviews remain unbiased and authentic."
    },
    {
